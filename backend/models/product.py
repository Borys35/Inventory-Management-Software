class Product:
    ...
    def update_product(self, id, sku, name, description, supplier_id, manufacturer_id, reorder_level):
        try:
            cur = self.conn.cursor()
            query = """
                UPDATE products
                ...
                RETURNING id;
            """
            cur.execute(query, (sku, name, description, supplier_id, manufacturer_id, reorder_level, id))
